...
/* Note that the value check was disabled for the following configuration
 * macros, which makes it possible to link them to a function, allowing a more
...
#define BOOT_COM_NET_DEFERRED_INIT_ENABLE (0)
    ...
    (BOOT_COM_NET_DEFERRED_INIT_ENABLE > 1)
...
#if (BOOT_COM_CAN_ENABLE == 1) || (BOOT_COM_RS232_ENABLE == 1) ||              \
    (BOOT_COM_NET_ENABLE == 1) || (BOOT_COM_USB_ENABLE == 1)
...
/****************************************************************************************
 *   F I L E   S Y S T E M   I N T E R F A C E   C O N F I G U R A T I O N   C H
 *E C K
 ****************************************************************************************/
