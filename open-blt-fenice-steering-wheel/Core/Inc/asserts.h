 ...
 * Macro definitions
 ****************************************************************************************/
/* declare assertion macro's. ASSERT_CT is for compile time assertions and
 * ASSERT_RT is for runtime assertions.
 */
#ifdef NDEBUG
...
#define ASSERT_CT(cond)                                                        \
  enum { ASSERT_CONCAT(assert_error_on_line_, __LINE__) = 1 / (!!(cond)) }
