 ...
 * Include files
 ****************************************************************************************/
/* Note that it is possible to override the standard blt_conf.h configuration
 * header file with a project specific one that is defined in the IDE/makefile.
 * For example, the following define could be configured:
 * PROJ_BLT_CONF_H="my_boot_config.h". This can be handy if you use the
 * bootloader in several projects with a different configuration, and enables
 * you to have just one bootloader source base.
 */
