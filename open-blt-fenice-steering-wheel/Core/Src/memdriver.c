...
int32_t MT48LC4M32B2_Init(SDRAM_HandleTypeDef *Ctx,
  ...
  if (MT48LC4M32B2_ClockEnable(Ctx, pRegMode->TargetBank) == MT48LC4M32B2_OK) {
    ...
    if (MT48LC4M32B2_Precharge(Ctx, pRegMode->TargetBank) == MT48LC4M32B2_OK) {
      ...
      if (MT48LC4M32B2_RefreshMode(Ctx, pRegMode->TargetBank,
                                   pRegMode->RefreshMode) == MT48LC4M32B2_OK) {
        /* Step 5: Program the external memory mode register */
        if (MT48LC4M32B2_ModeRegConfig(Ctx, pRegMode) == MT48LC4M32B2_OK) {
          /* Step 6: Set the refresh rate counter */
          if (MT48LC4M32B2_RefreshRate(Ctx, pRegMode->RefreshRate) ==
              MT48LC4M32B2_OK) {
            ret = MT48LC4M32B2_OK;
          }
        }
...
int32_t MT48LC4M32B2_ModeRegConfig(SDRAM_HandleTypeDef *Ctx,
  ...
  tmpmrd = (uint32_t)pRegMode->BurstLength | pRegMode->BurstType |
           pRegMode->CASLatency | pRegMode->OperationMode |
