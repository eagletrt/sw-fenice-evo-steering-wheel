 ...
 ****************************************************************************************/
/** \brief Local variable for storing the number of milliseconds that have
...
blt_int32u TimerGet(void) {
  /* Updating timer here allows this function to be called in a loop with
   * timeout detection.
   */
  TimerUpdate();
  /* Read and return the amount of milliseconds that passed since
   * initialization. */
