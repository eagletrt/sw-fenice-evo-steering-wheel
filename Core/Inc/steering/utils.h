...
static lv_obj_t *lv_triple_label(lv_obj_t *parent, const char *left_text, const lv_font_t *left_text_font , const char *right_text, const lv_font_t *right_text_font, const char *bottom_text, const lv_font_t *bottom_text_font )
{
    static lv_coord_t grid_col_dsc[] = {LV_GRID_CONTENT, LV_GRID_TEMPLATE_LAST};
    static lv_coord_t grid_row_dsc[] = {LV_GRID_CONTENT, LV_GRID_CONTENT, LV_GRID_TEMPLATE_LAST};
    ...
    lv_obj_t *up_l = lv_horizontal_pair_label(grid, left_text , left_text_font, right_text , &lv_font_montserrat_30);
