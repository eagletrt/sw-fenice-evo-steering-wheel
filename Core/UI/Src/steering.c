...
void hv_feedback_sd_voltage_update(UI_t *screen, bool valid) {
    ...
    update_shutdown_circuit_component(screen, shutdown_circuit_feedbacks_status_feedback_sd_end_index, primary_hv_feedback_sd_voltage_last_state->sd_end > 1.5f);
    update_shutdown_circuit_component(screen, shutdown_circuit_feedbacks_status_feedback_sd_out_index, primary_hv_feedback_sd_voltage_last_state->sd_out > 1.5f);
}
