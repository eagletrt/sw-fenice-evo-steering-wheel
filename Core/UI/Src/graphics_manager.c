        ...
        if (is_pmsg_new[iindex]) {
            ...
            switch (id) {
                ...
                case PRIMARY_HV_CURRENT_FRAME_ID: {
                    hv_current_update(is_pmsg_valid[iindex]);
                    break;
                }
                ...
                case PRIMARY_HV_ERRORS_FRAME_ID: {
                    hv_errors_update(is_pmsg_valid[iindex]);
                    break;
                }
                case PRIMARY_HV_FEEDBACK_TS_VOLTAGE_FRAME_ID: {
                    hv_feedback_ts_voltage_update(is_pmsg_valid[iindex]);
                    break;
                }
                case PRIMARY_HV_FEEDBACK_MISC_VOLTAGE_FRAME_ID: {
                    hv_feedback_misc_voltage_update(is_pmsg_valid[iindex]);
                    break;
                }
                case PRIMARY_HV_FEEDBACK_SD_VOLTAGE_FRAME_ID: {
                    hv_feedback_sd_voltage_update(is_pmsg_valid[iindex]);
                    break;
                }
                case PRIMARY_HV_BALANCING_STATUS_FRAME_ID: {
                    hv_cell_balancing_status_update(is_pmsg_valid[iindex]);
                    break;
                }
                ...
                case PRIMARY_HV_FEEDBACK_STATUS_FRAME_ID: {
                    hv_feedbacks_status_update(is_pmsg_valid[iindex]);
                    break;
                }
                case PRIMARY_LV_FEEDBACK_SD_VOLTAGE_FRAME_ID: {
                    lv_feedback_sd_voltage_update(is_pmsg_valid[iindex]);
                    break;
                }
                case PRIMARY_LV_FEEDBACK_TS_VOLTAGE_FRAME_ID: {
                    lv_feedback_ts_voltage_update(is_pmsg_valid[iindex]);
                    break;
                }
                case PRIMARY_LV_FEEDBACK_ENCLOSURE_VOLTAGE_FRAME_ID: {
                    lv_feedback_enclosure_voltage_update(is_pmsg_valid[iindex]);
                    break;
                }
                case PRIMARY_LV_ERRORS_FRAME_ID: {
                    lv_errors_update(is_pmsg_valid[iindex]);
                    break;
                }
                ...
                case PRIMARY_LV_RADIATOR_SPEED_FRAME_ID: {
                    lv_radiator_speed_update(is_pmsg_valid[iindex]);
                    break;
                }
                case PRIMARY_LV_PUMPS_SPEED_FRAME_ID: {
                    lv_pumps_speed_update(is_pmsg_valid[iindex]);
                    break;
                }
                ...
                case PRIMARY_LV_CELLS_VOLTAGE_FRAME_ID: {
                    lv_cells_voltage_update(is_pmsg_valid[iindex]);
                    break;
                }
        ...
        if (is_smsg_new[iindex]) {
            ...
            switch (id) {
                case SECONDARY_FRONT_ANGULAR_VELOCITY_FRAME_ID: {
                    angular_velocity_update(is_smsg_valid[iindex]);
                    break;
                }
                ...
                case SECONDARY_PEDAL_THROTTLE_FRAME_ID: {
                    pedal_throttle_update(is_smsg_valid[iindex]);
                    break;
                }
                ...
                case SECONDARY_IMU_ACCELERATION_FRAME_ID: {
                    imu_acceleration_update(is_smsg_valid[iindex]);
                    break;
                }
