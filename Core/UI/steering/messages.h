...
#define PRIMARY_MONITORED_MESSAGES                                             \
  {                                                                            \
    ...
    PRIMARY_PEDAL_CALIBRATION_ACK_FRAME_ID,       \
    PRIMARY_STEERING_JMP_TO_BLT_FRAME_ID, \
    PRIMARY_PTT_STATUS_FRAME_ID,     \
    PRIMARY_TLM_STATUS_FRAME_ID, \
    PRIMARY_AMBIENT_TEMPERATURE_FRAME_ID,     \
    PRIMARY_SPEED_FRAME_ID, \
    PRIMARY_HV_VOLTAGE_FRAME_ID,                   \
    PRIMARY_HV_CURRENT_FRAME_ID, \
    PRIMARY_HV_TEMP_FRAME_ID,                 \
    PRIMARY_HV_ERRORS_FRAME_ID, \
    PRIMARY_HV_FEEDBACKS_STATUS_FRAME_ID,      \
    PRIMARY_HV_CELLS_VOLTAGE_FRAME_ID, \
    PRIMARY_HV_CELLS_TEMP_FRAME_ID,     \
    PRIMARY_DAS_ERRORS_FRAME_ID, \
    PRIMARY_LV_CURRENTS_FRAME_ID,             \
    PRIMARY_LV_CELLS_VOLTAGE_FRAME_ID, \
    PRIMARY_LV_CELLS_TEMP_FRAME_ID,     \
    PRIMARY_LV_TOTAL_VOLTAGE_FRAME_ID, \
    PRIMARY_LV_ERRORS_FRAME_ID          \
  }
