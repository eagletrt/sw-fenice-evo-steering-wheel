...
{
    CHECK_CURRENT_TAB(racing, TAB_HV);
...
void init_hv_styles(void)
{
    ...
    lv_style_set_bg_color(&balancing_columns_style, lv_color_hex(COLOR_GREEN_STATUS_HEX));
    ...
    lv_style_set_bg_color(&tab_hv_style_indic, lv_palette_main(LV_PALETTE_RED));
    lv_style_set_bg_grad_color(&tab_hv_style_indic, lv_palette_main(LV_PALETTE_BLUE));
...
void tab_hv_create(lv_obj_t *parent)
{
    ...
    lv_obj_t *inv_l_temp_lb = lv_triple_label(
        top_data_panel, &tab_hv_labels[tab_hv_lb_temp_max],
    ...
    lv_obj_t *inv_r_temp_lb = lv_triple_label(
        top_data_panel, &tab_hv_labels[tab_hv_lb_temp_min],
    ...
    lv_obj_t *motor_l_temp_lb = lv_triple_label(
        top_data_panel, &tab_hv_labels[tab_hv_lb_temp_avg],
    ...
    lv_obj_t *motor_r_temp_lb = lv_triple_label(
        top_data_panel, &tab_hv_labels[tab_hv_lb_voltage_max],
    ...
    lv_obj_t *hv_temp_lb = lv_triple_label(
        top_data_panel, &tab_hv_labels[tab_hv_lb_voltage_min],
    ...
    lv_obj_t *hv_volt_lb = lv_triple_label(
        top_data_panel, &tab_hv_labels[tab_hv_lb_voltage_delta], "0",
    ...
    lv_obj_t *hv_curr_lb = lv_triple_label(
        top_data_panel, &tab_hv_labels[tab_hv_lb_pack_voltage], "0",
    ...
    lv_obj_t *hv_minCellV_lb = lv_triple_label(
        top_data_panel, &tab_hv_labels[tab_hv_lb_pack_voltage_2],
    ...
    lv_obj_t *status_lb = lv_triple_label(
        center_data_panel, &tab_hv_labels[tab_hv_lb_current_state],
        "X", &lv_font_inter_bold_30, "", &lv_font_inter_bold_22, "STATUS",
        &lv_font_inter_bold_20);
    lv_obj_set_grid_cell(status_lb, LV_GRID_ALIGN_CENTER, 0, 1,
                         LV_GRID_ALIGN_CENTER, 0, 1);

    lv_obj_t *error_lb = lv_triple_label(
        center_data_panel, &tab_hv_labels[tab_hv_lb_last_error],
        "X", &lv_font_inter_bold_30, "", &lv_font_inter_bold_22, "ERROR",
        &lv_font_inter_bold_20);
    ...
    static lv_coord_t bal_panel_cols[] = {B_COLUMN_WIDTH, B_COLUMN_WIDTH,
                                          B_COLUMN_WIDTH, B_COLUMN_WIDTH,
                                          B_COLUMN_WIDTH, B_COLUMN_WIDTH,
                                          LV_GRID_TEMPLATE_LAST};
    ...
    static lv_coord_t pork_panel_rows[] = {(B_COLUMN_HEIGHT) / 3,
                                           (B_COLUMN_HEIGHT) / 3,
                                           (B_COLUMN_HEIGHT) / 3, LV_GRID_TEMPLATE_LAST};
    ...
    lv_obj_set_grid_cell(tab_hv_labels[shutdown_status], LV_GRID_ALIGN_CENTER, 0, 1,
    ...
    lv_obj_set_style_text_font(tab_hv_labels[tab_hv_pork_speed_value], &lv_font_inter_bold_30,
                               LV_STATE_DEFAULT);
    lv_label_set_text(tab_hv_labels[tab_hv_pork_speed_value], "-");
    lv_obj_set_grid_cell(tab_hv_labels[tab_hv_pork_speed_value], LV_GRID_ALIGN_CENTER, 1, 1,
                         LV_GRID_ALIGN_CENTER, 0, 1);
