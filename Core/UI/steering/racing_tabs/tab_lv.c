...
void tab_lv_create(lv_obj_t *parent) {
  ...
  static lv_coord_t dpanel_rows[] = {100, DATA_PANEL_HEIGHT - 100,
                                     LV_GRID_TEMPLATE_LAST};
  ...
  lv_obj_t *inv_l_temp_lb =
      lv_triple_label(top_data_panel, &tab_lv_labels[tab_lv_lb_temp_max], "X",
  ...
  lv_obj_t *inv_r_temp_lb =
      lv_triple_label(top_data_panel, &tab_lv_labels[tab_lv_lb_temp_min], "X",
                      &lv_font_inter_bold_30, "°C", &lv_font_inter_bold_22,
  ...
  lv_obj_t *motor_l_temp_lb =
      lv_triple_label(top_data_panel, &tab_lv_labels[tab_lv_lb_temp_avg], "X",
                      &lv_font_inter_bold_30, "°C", &lv_font_inter_bold_22,
  ...
  lv_obj_t *motor_r_temp_lb =
      lv_triple_label(top_data_panel, &tab_lv_labels[tab_lv_lb_voltage_max],
  ...
  lv_obj_t *lv_temp_lb =
      lv_triple_label(top_data_panel, &tab_lv_labels[tab_lv_lb_voltage_min],
  ...
  lv_obj_t *lv_volt_lb =
      lv_triple_label(top_data_panel, &tab_lv_labels[tab_lv_lb_voltage_delta],
  ...
  lv_obj_t *lv_curr_lb =
      lv_triple_label(top_data_panel, &tab_lv_labels[tab_lv_lb_pack_voltage],
                      "0", &lv_font_inter_bold_30, " V", &lv_font_inter_bold_22,
  ...
  static lv_coord_t center_panel_cols[] = {
      CP_COLUMN_WIDTH, CP_COLUMN_WIDTH, CP_COLUMN_WIDTH, LV_GRID_TEMPLATE_LAST};
  static lv_coord_t center_panel_rows[] = {CENTRAL_PANEL_HEIGHT,
                                           LV_GRID_TEMPLATE_LAST};
  ...
  /* PUMPS PANEL */
  static lv_coord_t pumps_panel_cols[] = {CP_COLUMN_WIDTH,
                                          LV_GRID_TEMPLATE_LAST};
  static lv_coord_t pumps_panel_rows[] = {
      SUB_PANEL_HEADER_HEIGHT, (CENTRAL_PANEL_HEIGHT - SUB_PANEL_HEADER_HEIGHT),
      LV_GRID_TEMPLATE_LAST};
  ...
  lv_obj_set_style_text_font(pumps_label, &lv_font_inter_bold_30,
                             LV_STATE_DEFAULT);
  ...
  /* PUMPS BAR PANEL */
  static lv_coord_t pumps_bar_panel_cols[] = {
      CP_COLUMN_WIDTH / 3, CP_COLUMN_WIDTH / 3, CP_COLUMN_WIDTH / 3,
      LV_GRID_TEMPLATE_LAST};
  static lv_coord_t pumps_bar_panel_rows[] = {BAR_HEIGHT,
                                              LV_GRID_TEMPLATE_LAST};
  ...
  lv_obj_set_grid_dsc_array(pumps_bar_panel, pumps_bar_panel_cols,
                            pumps_bar_panel_rows);
  ...
  lv_obj_t *pumps_local_value = lv_horizontal_pair_label(
      pumps_bar_panel, &tab_lv_labels[tab_lv_lb_pumps_local], "0",
      &lv_font_inter_bold_30, "%", &lv_font_inter_bold_20);
  lv_obj_set_grid_cell(pumps_local_value, LV_GRID_ALIGN_START, 2, 1,
                       LV_GRID_ALIGN_START, 0, 1);

  /* STATUS PANEL */
  static lv_coord_t status_panel_cols[] = {CP_COLUMN_WIDTH,
                                           LV_GRID_TEMPLATE_LAST};
  static lv_coord_t status_panel_rows[] = {((CENTRAL_PANEL_HEIGHT) / 2),
                                           ((CENTRAL_PANEL_HEIGHT) / 2),
                                           LV_GRID_TEMPLATE_LAST};
  ...
  lv_obj_set_style_text_font(status_label, &lv_font_inter_bold_30,
                             LV_STATE_DEFAULT);
  ...
  lv_obj_set_style_text_font(tab_lv_labels[tab_lv_lb_state],
                             &lv_font_inter_bold_30, LV_STATE_DEFAULT);
  lv_obj_set_style_text_color(tab_lv_labels[tab_lv_lb_state],
                              lv_color_hex(0xffffff), 0);
  lv_obj_set_grid_cell(tab_lv_labels[tab_lv_lb_state], LV_GRID_ALIGN_CENTER, 0,
                       1, LV_GRID_ALIGN_START, 1, 1);

  /*--- creating RADIATORS PANEL ---*/
  static lv_coord_t radiators_panel_cols[] = {CP_COLUMN_WIDTH,
                                              LV_GRID_TEMPLATE_LAST};
  static lv_coord_t radiators_panel_rows[] = {
      SUB_PANEL_HEADER_HEIGHT, (CENTRAL_PANEL_HEIGHT - SUB_PANEL_HEADER_HEIGHT),
      LV_GRID_TEMPLATE_LAST};
  ...
  lv_obj_set_grid_dsc_array(radiators_panel, radiators_panel_cols,
                            radiators_panel_rows);
  ...
  lv_obj_set_style_text_font(radiators_label, &lv_font_inter_bold_30,
                             LV_STATE_DEFAULT);
  ...
  /* RADIATORS BAR PANEL */
  static lv_coord_t radiators_bar_panel_cols[] = {
      CP_COLUMN_WIDTH / 3, CP_COLUMN_WIDTH / 3, CP_COLUMN_WIDTH / 3,
      LV_GRID_TEMPLATE_LAST};
  static lv_coord_t radiators_bar_panel_rows[] = {BAR_HEIGHT,
                                                  LV_GRID_TEMPLATE_LAST};
  ...
  lv_obj_set_grid_dsc_array(radiators_bar_panel, radiators_bar_panel_cols,
                            radiators_bar_panel_rows);
  ...
  lv_obj_t *radiators_local_value = lv_horizontal_pair_label(
      radiators_bar_panel, &tab_lv_labels[tab_lv_lb_radiators_local], "0",
      &lv_font_inter_bold_30, "%", &lv_font_inter_bold_20);
