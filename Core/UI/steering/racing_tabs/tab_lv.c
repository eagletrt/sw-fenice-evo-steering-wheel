...
{
  CHECK_CURRENT_TAB(racing, TAB_LV);
...
void lv_pumps_speed_bar_invalidate()
{
  ...
  //   lv_obj_add_style(tab_lv_pumps_speed_bar, &style_indic, LV_PART_INDICATOR);
}
...
void lv_radiators_speed_bar_invalidate()
{
  ...
  //   lv_style_set_bg_color(&style_indic, lv_palette_main(LV_PALETTE_RED));
  //   lv_obj_add_style(tab_lv_radiators_speed_bar, &style_indic, LV_PART_INDICATOR);
}
...
void tab_lv_create(lv_obj_t *parent)
{
  ...
  lv_obj_t *notch = create_notch(main_panel, TAB_LV);
  ...
  static lv_coord_t dpanel_cols[] = {SCREEN_WIDTH,
                                     LV_GRID_TEMPLATE_LAST};
  ...
  static lv_coord_t rxd_panel_cols[] = {DATA_PANEL_WIDTH / 8, DATA_PANEL_WIDTH / 8,
                                        DATA_PANEL_WIDTH / 8, DATA_PANEL_WIDTH / 8,
                                        DATA_PANEL_WIDTH / 8, DATA_PANEL_WIDTH / 8,
                                        DATA_PANEL_WIDTH / 8, DATA_PANEL_WIDTH / 8,
                                        LV_GRID_TEMPLATE_LAST};
  ...
  lv_obj_t *inv_l_temp_lb = lv_triple_label(
      top_data_panel, &tab_lv_labels[tab_lv_lb_temp_max],
      "X", &lv_font_inter_bold_30, "°C", &lv_font_inter_bold_22, "MAX",
  ...
  lv_obj_t *inv_r_temp_lb = lv_triple_label(
      top_data_panel, &tab_lv_labels[tab_lv_lb_temp_min],
      "X", &lv_font_inter_bold_30, "°C", &lv_font_inter_bold_22, "MIN",
      &lv_font_inter_bold_20);
  lv_obj_set_grid_cell(inv_r_temp_lb, LV_GRID_ALIGN_CENTER, 1, 1,
                       LV_GRID_ALIGN_CENTER, 0, 1);

  lv_obj_t *motor_l_temp_lb = lv_triple_label(
      top_data_panel, &tab_lv_labels[tab_lv_lb_temp_avg],
      "X", &lv_font_inter_bold_30, "°C", &lv_font_inter_bold_22, "AVG",
      &lv_font_inter_bold_20);
  ...
  lv_obj_t *motor_r_temp_lb = lv_triple_label(
      top_data_panel, &tab_lv_labels[tab_lv_lb_voltage_max],
      "X", &lv_font_inter_bold_30, " V", &lv_font_inter_bold_22, "MAX",
      &lv_font_inter_bold_20);
  lv_obj_set_grid_cell(motor_r_temp_lb, LV_GRID_ALIGN_CENTER, 3, 1,
                       LV_GRID_ALIGN_CENTER, 0, 1);

  lv_obj_t *lv_temp_lb = lv_triple_label(
      top_data_panel, &tab_lv_labels[tab_lv_lb_voltage_min],
      "0", &lv_font_inter_bold_30, " V", &lv_font_inter_bold_22, "MIN",
      &lv_font_inter_bold_20);
  lv_obj_set_grid_cell(lv_temp_lb, LV_GRID_ALIGN_CENTER, 4, 1,
                       LV_GRID_ALIGN_CENTER, 0, 1);

  lv_obj_t *lv_volt_lb = lv_triple_label(
      top_data_panel, &tab_lv_labels[tab_lv_lb_voltage_delta], "0",
      &lv_font_inter_bold_30, " mV", &lv_font_inter_bold_22, "DELTA",
      &lv_font_inter_bold_20);
  lv_obj_set_grid_cell(lv_volt_lb, LV_GRID_ALIGN_CENTER, 5, 1,
                       LV_GRID_ALIGN_CENTER, 0, 1);

  lv_obj_t *lv_curr_lb = lv_triple_label(
      top_data_panel, &tab_lv_labels[tab_lv_lb_pack_voltage], "0",
      &lv_font_inter_bold_30, " V", &lv_font_inter_bold_22, "PACK",
      &lv_font_inter_bold_20);
  lv_obj_set_grid_cell(lv_curr_lb, LV_GRID_ALIGN_CENTER, 6, 1,
                       LV_GRID_ALIGN_CENTER, 0, 1);

  lv_obj_t *lv_minCellV_lb = lv_triple_label(
      top_data_panel, &tab_lv_labels[tab_lv_lb_pack_voltage_2],
      "0", &lv_font_inter_bold_30, " V", &lv_font_inter_bold_22, "PACK 2",
      &lv_font_inter_bold_20);
  ...
  static lv_coord_t center_panel_cols[] = {CP_COLUMN_WIDTH,
                                           CP_COLUMN_WIDTH,
                                           CP_COLUMN_WIDTH, LV_GRID_TEMPLATE_LAST};
  ...
  static lv_coord_t pumps_panel_rows[] = {SUB_PANEL_HEADER_HEIGHT,
                                          (CENTRAL_PANEL_HEIGHT - SUB_PANEL_HEADER_HEIGHT), LV_GRID_TEMPLATE_LAST};
  ...
  lv_obj_set_grid_cell(pumps_panel, LV_GRID_ALIGN_STRETCH, 0, 1,
                       LV_GRID_ALIGN_STRETCH, 0, 1);
  ...
  lv_obj_set_grid_cell(pumps_label, LV_GRID_ALIGN_CENTER, 0, 1,
                       LV_GRID_ALIGN_CENTER, 0, 1);

  /* PUMPS BAR PANEL */
  static lv_coord_t pumps_bar_panel_cols[] = {CP_COLUMN_WIDTH / 3,
                                              CP_COLUMN_WIDTH / 3,
                                              CP_COLUMN_WIDTH / 3, LV_GRID_TEMPLATE_LAST};
  ...
  lv_obj_t *pumps_actual_value = lv_horizontal_pair_label(pumps_bar_panel, &tab_lv_labels[tab_lv_lb_pumps_actual], "0", &lv_font_inter_bold_30, "%", &lv_font_inter_bold_20);
  ...
  lv_obj_set_grid_cell(tab_lv_pumps_speed_bar, LV_GRID_ALIGN_CENTER, 1, 1,
                       LV_GRID_ALIGN_CENTER, 0, 1);

  lv_obj_t *pumps_local_value = lv_horizontal_pair_label(pumps_bar_panel, &tab_lv_labels[tab_lv_lb_pumps_local], "0", &lv_font_inter_bold_30, "%", &lv_font_inter_bold_20);
  lv_obj_set_grid_cell(pumps_local_value, LV_GRID_ALIGN_START, 2, 1,
                       LV_GRID_ALIGN_START, 0, 1);

  /* STATUS PANEL */
  static lv_coord_t status_panel_cols[] = {CP_COLUMN_WIDTH, LV_GRID_TEMPLATE_LAST};
  static lv_coord_t status_panel_rows[] = {((CENTRAL_PANEL_HEIGHT) / 2),
                                           ((CENTRAL_PANEL_HEIGHT) / 2), LV_GRID_TEMPLATE_LAST};
  ...
  lv_obj_set_grid_cell(status_panel, LV_GRID_ALIGN_STRETCH, 1, 1,
                       LV_GRID_ALIGN_STRETCH, 0, 1);
  ...
  lv_obj_set_grid_cell(status_label, LV_GRID_ALIGN_CENTER, 0, 1,
                       LV_GRID_ALIGN_CENTER, 0, 1);
  ...
  lv_obj_set_grid_cell(tab_lv_labels[tab_lv_lb_state], LV_GRID_ALIGN_CENTER, 0, 1,
  ...
  static lv_coord_t radiators_panel_rows[] = {SUB_PANEL_HEADER_HEIGHT,
                                              (CENTRAL_PANEL_HEIGHT - SUB_PANEL_HEADER_HEIGHT), LV_GRID_TEMPLATE_LAST};
  ...
  lv_obj_set_grid_cell(radiators_panel, LV_GRID_ALIGN_STRETCH, 2, 1,
                       LV_GRID_ALIGN_STRETCH, 0, 1);
  ...
  lv_obj_set_grid_cell(radiators_label, LV_GRID_ALIGN_CENTER, 0, 1,
                       LV_GRID_ALIGN_CENTER, 0, 1);

  /* RADIATORS BAR PANEL */
  static lv_coord_t radiators_bar_panel_cols[] = {CP_COLUMN_WIDTH / 3,
                                                  CP_COLUMN_WIDTH / 3,
                                                  CP_COLUMN_WIDTH / 3, LV_GRID_TEMPLATE_LAST};
  ...
  lv_obj_t *radiators_actual_value = lv_horizontal_pair_label(radiators_bar_panel, &tab_lv_labels[tab_lv_lb_radiators_actual], "0", &lv_font_inter_bold_30, "%", &lv_font_inter_bold_20);
  ...
  lv_obj_set_grid_cell(tab_lv_radiators_speed_bar, LV_GRID_ALIGN_CENTER, 1, 1,
                       LV_GRID_ALIGN_CENTER, 0, 1);

  lv_obj_t *radiators_local_value = lv_horizontal_pair_label(radiators_bar_panel, &tab_lv_labels[tab_lv_lb_radiators_local], "0", &lv_font_inter_bold_30, "%", &lv_font_inter_bold_20);
