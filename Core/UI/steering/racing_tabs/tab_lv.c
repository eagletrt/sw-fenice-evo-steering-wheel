...
void tab_lv_create(lv_obj_t *parent) {
    ...
    lv_obj_t *pumps_actual_value =
        lv_horizontal_pair_label(pumps_bar_panel, &tab_lv_labels[tab_lv_lb_pumps_name], NULL, "", &lv_font_inter_bold_30, "", &lv_font_inter_bold_20);
    ...
    lv_obj_t *pumps_local_value =
        lv_horizontal_pair_label(pumps_bar_panel, &tab_lv_labels[tab_lv_lb_pumps_value], NULL, "NA", &lv_font_inter_bold_30, "%", &lv_font_inter_bold_20);
    ...
    lv_obj_t *radiators_actual_value =
        lv_horizontal_pair_label(radiators_bar_panel, &tab_lv_labels[tab_lv_lb_radiators_name], NULL, "", &lv_font_inter_bold_30, "", &lv_font_inter_bold_20);
