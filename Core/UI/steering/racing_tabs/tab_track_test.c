...
void set_tab_track_test_lb_speed(const char *s) {
  CHECK_CURRENT_TAB(racing, TAB_TRACK_TEST);
...
#define tab_terminal_col_ration_base (SCREEN_WIDTH - 100) / 3
  static lv_coord_t tab_terminal_cols_ratios[] = {
      tab_terminal_col_ration_base, tab_terminal_col_ration_base,
      tab_terminal_col_ration_base, LV_GRID_TEMPLATE_LAST};
  ...
  lv_obj_t *x_axis_h = lv_vertical_pair_label(
      label_panel, &tab_track_test_lb_target, "0", &lv_font_inter_bold_30,
  ...
  lv_obj_t *x_axis_g = lv_vertical_pair_label(
      label_panel, &tab_track_test_lb_speed, "0", &lv_font_inter_bold_30,
      "SPEED\nKM/H", &lv_font_inter_bold_22);
  lv_obj_set_grid_cell(x_axis_g, LV_GRID_ALIGN_CENTER, 1, 1,
                       LV_GRID_ALIGN_CENTER, 0, 1);

  lv_obj_t *x_axis_j =
      lv_vertical_pair_label(label_panel, &tab_track_test_lb_steering_angle,
                             "0", &lv_font_inter_bold_30,
                             "STEERING ANGLE\ndegrees", &lv_font_inter_bold_22);
