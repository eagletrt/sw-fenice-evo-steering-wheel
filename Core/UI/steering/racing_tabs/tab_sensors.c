...
void tab_sensors_create(lv_obj_t *parent) {
    ...
    lv_obj_t *front_lx_temp =
        lv_horizontal_pair_label(frame_1, &tab_sensors_labels[tab_sensors_lb_fl_temp], "X", &lv_font_inter_bold_30, "°C", &lv_font_inter_bold_22);
    lv_obj_align(front_lx_temp, LV_ALIGN_CENTER, -60, -70);

    lv_obj_t *front_rx_temp =
        lv_horizontal_pair_label(frame_1, &tab_sensors_labels[tab_sensors_lb_fr_temp], "X", &lv_font_inter_bold_30, "°C", &lv_font_inter_bold_22);
    lv_obj_align(front_rx_temp, LV_ALIGN_CENTER, 60, -70);

    lv_obj_t *rear_lx_temp =
        lv_horizontal_pair_label(frame_1, &tab_sensors_labels[tab_sensors_lb_rl_temp], "X", &lv_font_inter_bold_30, "°C", &lv_font_inter_bold_22);
    lv_obj_align(rear_lx_temp, LV_ALIGN_CENTER, -60, 70);

    lv_obj_t *rear_rx_temp =
        lv_horizontal_pair_label(frame_1, &tab_sensors_labels[tab_sensors_lb_rr_temp], "X", &lv_font_inter_bold_30, "°C", &lv_font_inter_bold_22);
    ...
    lv_obj_t *front_lx_press =
        lv_horizontal_pair_label(frame_2, &tab_sensors_labels[tab_sensors_lb_fl_press], "X", &lv_font_inter_bold_30, " bar", &lv_font_inter_bold_22);
    lv_obj_align(front_lx_press, LV_ALIGN_CENTER, -60, -70);

    lv_obj_t *front_rx_press =
        lv_horizontal_pair_label(frame_2, &tab_sensors_labels[tab_sensors_lb_fr_press], "X", &lv_font_inter_bold_30, " bar", &lv_font_inter_bold_22);
    lv_obj_align(front_rx_press, LV_ALIGN_CENTER, 60, -70);

    lv_obj_t *rear_lx_press =
        lv_horizontal_pair_label(frame_2, &tab_sensors_labels[tab_sensors_lb_rl_press], "X", &lv_font_inter_bold_30, " bar", &lv_font_inter_bold_22);
    lv_obj_align(rear_lx_press, LV_ALIGN_CENTER, -60, 70);

    lv_obj_t *rear_rx_press =
        lv_horizontal_pair_label(frame_2, &tab_sensors_labels[tab_sensors_lb_rr_press], "X", &lv_font_inter_bold_30, " bar", &lv_font_inter_bold_22);
