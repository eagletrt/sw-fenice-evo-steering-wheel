...
lv_obj_t *lv_vertical_pair_label(
    ...
    *main_l = lv_label_create(up_o);
    ...
    lv_obj_set_grid_cell(up_o, LV_GRID_ALIGN_CENTER, 0, 1, LV_GRID_ALIGN_CENTER, 0, 1);
    ...
    lv_obj_set_grid_cell(bot_o, LV_GRID_ALIGN_STRETCH, 0, 1, LV_GRID_CONTENT, 1, 1);
    if (aux_l != NULL)
        *aux_l = bl;
...
lv_obj_t *lv_horizontal_pair_label(
    ...
    *main_l = lv_label_create(grid);
    ...
    lv_obj_align(*main_l, LV_ALIGN_CENTER, 0, 0);
    lv_obj_set_grid_cell(*main_l, LV_GRID_ALIGN_CENTER, 0, 1, LV_GRID_ALIGN_CENTER, 0, 1);
...
lv_obj_t *lv_triple_label(
    ...
    lv_obj_t *up_l = lv_horizontal_pair_label(grid, main_l, NULL, left_text, left_text_font, right_text, right_text_font);
...
lv_obj_t *create_notch(lv_obj_t *parent, racing_tab_t TabId) {
    ...
    lv_obj_set_grid_cell(center, LV_GRID_ALIGN_CENTER, 2, 1, LV_GRID_ALIGN_START, 0, 1);
    ...
    lv_obj_set_grid_cell(right, LV_GRID_ALIGN_CENTER, 3, 1, LV_GRID_ALIGN_START, 0, 1);
...
void init_custom_styles(void) {
    ...
    lv_style_set_border_color(&box_panels_style,
                              lv_color_hex(COLOR_SECONDARY_HEX));  // to remove borders, keeping bc useful
