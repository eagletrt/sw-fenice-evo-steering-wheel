...
void handle_primary(can_message_t *msg) {
    ...
    switch (id) {
        ...
        case PRIMARY_LV_CELLS_VOLTAGE_FRAME_ID: {
            STEER_CAN_UNPACK(primary, PRIMARY, lv_cells_voltage, LV_CELLS_VOLTAGE, is_pmsg, true);
        ...
        case PRIMARY_LV_CELLS_TEMP_FRAME_ID: {
            STEER_CAN_UNPACK(primary, PRIMARY, lv_cells_temp, LV_CELLS_TEMP, is_pmsg, true);
            switch (last_state->start_index) {
                case 0:
