...
void tab_balancing_status_screen_create(lv_obj_t *parent) {
    ...
    lv_obj_set_style_bg_color(bal_status_tab_background, lv_color_hex(COLOR_PRIMARY_HEX), LV_PART_MAIN);
    ...
    lv_obj_set_style_text_font(bal_status_label, &lv_font_inter_bold_38, LV_PART_MAIN);
