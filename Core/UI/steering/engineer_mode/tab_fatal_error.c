...
void init_tab_fatal_error_styles() {
  ...
  lv_style_set_text_color(&tab_fatal_error_style,
...
void tab_fatal_error_create(lv_obj_t *parent) {
  ...
  lv_obj_set_style_bg_color(tab_fe_background,
  ...
  lv_obj_set_style_text_font(tab_fatal_error_label, &lv_font_inter_bold_38,
                             LV_PART_MAIN);
