...
void tab_engineer_screen_create(lv_obj_t *parent) {
  ...
  static lv_coord_t tab_engineer_mod_rows_ratios[] = {
      SCREEN_HEIGHT, LV_GRID_TEMPLATE_LAST};
  ...
  lv_label_set_text(cs_l4, 
   "Controlli" SPACING
   "PADDLE ALTI" SPACING
                           "PADDLE ALTO DX LONG PRESS" SPACING
                           "PADDLE BASSI" SPACING
                           "BOTTONE VERDE ALTO SX" SPACING
                           "BOTTONE VERDE ALTO DX" SPACING
                           "BOTTONE GIALLO BASSO SX" SPACING
                           "BOTTONE GIALLO BASSO DX" SPACING
                           "BOTTONE CENTRALE");
  ...
  lv_label_set_text(cs_l6, "engineer tabs" SPACING "Cambio di tab" SPACING
                           "Cambio a modalita' racing" SPACING
                           "Cambio cansniffer tab" SPACING
                           "Attivare Shutdown Tab(sulla tab giusta)" SPACING
                           "Attivare CanDump (sulla tab giusta)" SPACING
                           "Niente (per ora)" SPACING
                           "Niente (per ora)" SPACING
                           "SEND CAR STATUS");
