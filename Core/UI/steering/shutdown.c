...
char shutdown_labels[SHUTDOWN_COMPONENT_SIZE][20] = {
  "SD start", 
  "SD in",
  "SD out",
  "TSAC interlock",
...
void update_shutdown_circuit_component(shutdown_circuit_indexes_t idx, float shutdown_circuit_state){
    shutdown_status_array[idx] = !(shutdown_circuit_state < 12.0f); // 12V is the value for considering the shutdown circuit closed
