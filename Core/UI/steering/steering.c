...
void hv_errors_update() {
  ...
  set_label_color_hv_errors(primary_hv_errors_last_state->errors_cell_low_voltage, 0);
  set_label_color_hv_errors(primary_hv_errors_last_state->errors_cell_under_voltage, 1);
  set_label_color_hv_errors(primary_hv_errors_last_state->errors_cell_over_voltage, 2);
  set_label_color_hv_errors(primary_hv_errors_last_state->errors_cell_high_temperature,
                            3);
  set_label_color_hv_errors(primary_hv_errors_last_state->errors_cell_over_temperature,
                            4);
  set_label_color_hv_errors(primary_hv_errors_last_state->errors_over_current, 5);
  set_label_color_hv_errors(primary_hv_errors_last_state->errors_can, 6);
  set_label_color_hv_errors(primary_hv_errors_last_state->errors_int_voltage_mismatch,
                            7);
  set_label_color_hv_errors(primary_hv_errors_last_state->errors_cellboard_comm, 8);
  set_label_color_hv_errors(primary_hv_errors_last_state->errors_cellboard_internal, 9);
  set_label_color_hv_errors(primary_hv_errors_last_state->errors_connector_disconnected,
                            10);
  set_label_color_hv_errors(primary_hv_errors_last_state->errors_fans_disconnected, 11);
  set_label_color_hv_errors(primary_hv_errors_last_state->errors_feedback, 12);
  set_label_color_hv_errors(primary_hv_errors_last_state->errors_feedback_circuitry, 13);
  set_label_color_hv_errors(primary_hv_errors_last_state->errors_eeprom_comm, 14);
...
void das_errors_update() {
  ...
  set_label_color_das_errors(primary_das_errors_last_state->das_error_pedal_adc, 0);
  set_label_color_das_errors(
          primary_das_errors_last_state->das_error_pedal_implausibility, 1);
  set_label_color_das_errors(primary_das_errors_last_state->das_error_imu_tout, 2);
  set_label_color_das_errors(primary_das_errors_last_state->das_error_irts_tout, 3);
  set_label_color_das_errors(primary_das_errors_last_state->das_error_ts_tout, 4);
  set_label_color_das_errors(primary_das_errors_last_state->das_error_invl_tout, 5);
  set_label_color_das_errors(primary_das_errors_last_state->das_error_invr_tout, 6);
  set_label_color_das_errors(primary_das_errors_last_state->das_error_steer_tout, 7);
  set_label_color_das_errors(primary_das_errors_last_state->das_error_fsm, 8);
}
...
void lv_errors_update() {
  ...
  set_label_color_lv_errors(primary_lv_errors_last_state->errors_cell_undervoltage, 0);
  set_label_color_lv_errors(primary_lv_errors_last_state->errors_cell_overvoltage, 1);
  set_label_color_lv_errors(primary_lv_errors_last_state->errors_battery_open_wire, 2);
  set_label_color_lv_errors(primary_lv_errors_last_state->errors_can, 3);
  set_label_color_lv_errors(primary_lv_errors_last_state->errors_spi, 4);
  set_label_color_lv_errors(primary_lv_errors_last_state->errors_over_current, 5);
  set_label_color_lv_errors(primary_lv_errors_last_state->errors_cell_under_temperature,
                            6);
  set_label_color_lv_errors(primary_lv_errors_last_state->errors_cell_over_temperature,
                            7);
  set_label_color_lv_errors(primary_lv_errors_last_state->errors_relay, 8);
  set_label_color_lv_errors(primary_lv_errors_last_state->errors_bms_monitor, 9);
  set_label_color_lv_errors(primary_lv_errors_last_state->errors_voltages_not_ready, 10);
  set_label_color_lv_errors(primary_lv_errors_last_state->errors_mcp23017, 11);
  set_label_color_lv_errors(primary_lv_errors_last_state->errors_radiator, 12);
  set_label_color_lv_errors(primary_lv_errors_last_state->errors_fan, 13);
  set_label_color_lv_errors(primary_lv_errors_last_state->errors_pump, 14);
  set_label_color_lv_errors(primary_lv_errors_last_state->errors_adc_init, 15);
  set_label_color_lv_errors(primary_lv_errors_last_state->errors_mux, 16);
}
