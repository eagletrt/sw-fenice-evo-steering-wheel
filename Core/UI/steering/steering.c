...
void inv_l_rcv_update(void) {
    ...
    if (inverters_inv_l_rcv_last_state->rcv_mux == INVERTERS_INV_L_RCV_RCV_MUX_ID_49_T_MOTOR_CHOICE) {
    ...
    if (inverters_inv_l_rcv_last_state->rcv_mux == INVERTERS_INV_L_RCV_RCV_MUX_ID_4A_T_IGBT_CHOICE) {
...
void inv_r_rcv_update() {
    ...
    if (inverters_inv_r_rcv_last_state->rcv_mux == INVERTERS_INV_R_RCV_RCV_MUX_ID_49_T_MOTOR_CHOICE) {
    ...
    if (inverters_inv_r_rcv_last_state->rcv_mux == INVERTERS_INV_R_RCV_RCV_MUX_ID_4A_T_IGBT_CHOICE) {
