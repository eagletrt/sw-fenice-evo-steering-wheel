...
#define BUTTONS_LONG_PRESS_TIME 300

#define MOTOR_TEMP_ALERT_THRESHOLD    (90.0f)
#define MOTOR_TEMP_CRITICAL_THRESHOLD (100.0f)

#define INVERTER_TEMP_ALERT_THRESHOLD    (67.0f)
#define INVERTER_TEMP_CRITICAL_THRESHOLD (73.0f)

#define SOC_HV_ALERT_THRESHOLD    (0.4f)
#define SOC_HV_CRITICAL_THRESHOLD (0.2f)

#define SOC_LV_ALERT_THRESHOLD    (0.4f)
#define SOC_LV_CRITICAL_THRESHOLD (0.2f)

#define HV_TEMP_ALERT_THRESHOLD    (52.0f)
#define HV_TEMP_CRITICAL_THRESHOLD (60.0f)
