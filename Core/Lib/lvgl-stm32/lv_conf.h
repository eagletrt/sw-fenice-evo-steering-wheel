...
#define LV_USE_STDLIB_SPRINTF   LV_STDLIB_BUILTIN
    ...
    #define LV_MEM_SIZE (2097152U)          /*[bytes]*/

    /*Size of the memory expand for `lv_malloc()` in bytes*/
    #define LV_MEM_POOL_EXPAND_SIZE (102400U) //TODO

    /*Set an address for the memory pool instead of allocating it as a normal array. Can be in external SRAM too.*/
    #define LV_MEM_ADR (0xC0400000U)     /*0: unused*/
...
#define LV_ASSERT_HANDLER while(1); // HAL_NVIC_SystemReset(); // while(1);   /*Halt by default*/
...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(lv_font_inter_bold_14)

/*Always set a default font*/
#define LV_FONT_DEFAULT (&lv_font_inter_bold_14)
