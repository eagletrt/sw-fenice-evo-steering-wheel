...
void tab_racing(lv_obj_t *parent) {
  ...
  lv_obj_t *lv_perc = lv_horizontal_pair_label(
      bar_panel_lv, &steering.lb_LV_PERCENT, "80", &lv_font_inter_bold_38, "%",
      &lv_font_inter_bold_18);
  ...
  lv_obj_t *hv_perc = lv_horizontal_pair_label(
      bar_panel_hv, &steering.lb_HV_PERCENT, "50", &lv_font_inter_bold_38, "%",
      &lv_font_inter_bold_18);
  ...
  lv_obj_t *best_time = lv_vertical_pair_label(
      left_data_panel, &steering.lb_BEST_TIME, " 1:24:03",
  ...
  lv_obj_t *last_time = lv_vertical_pair_label(
      left_data_panel, &steering.lb_LAST_TIME, " 1:25:33",
  ...
  lv_obj_t *delta = lv_vertical_pair_label(
      left_data_panel, &steering.lb_DELTA_TIME, "3.2", &lv_font_inter_bold_60,
      "DELTA", &lv_font_inter_bold_22);
  ...
  lv_obj_t *trq = lv_vertical_pair_label(right_data_panel, &steering.lb_TORQUE,
                                         "30", &lv_font_inter_bold_38, "TRQ",
  ...
  lv_obj_t *slip = lv_vertical_pair_label(right_data_panel, &steering.lb_SLIP,
                                          "20", &lv_font_inter_bold_38, "%",
                                          &lv_font_inter_bold_22);
  ...
  lv_obj_t *test =
      lv_triple_label(right_data_panel, &steering.lb_INVERTER_TEMP, "60",
                      ...
                      "INV", &lv_font_inter_bold_18);
  lv_obj_set_grid_cell(test, LV_GRID_ALIGN_CENTER, 0, 1, LV_GRID_ALIGN_CENTER,
                       1, 1);

  lv_obj_t *test1 = lv_triple_label(
      right_data_panel, &steering.lb_MOTOR_TEMP, "30", &lv_font_inter_bold_38,
      "°C", &lv_font_inter_bold_22, "MOTOR", &lv_font_inter_bold_18);
  lv_obj_set_grid_cell(test1, LV_GRID_ALIGN_CENTER, 0, 1, LV_GRID_ALIGN_CENTER,
                       2, 1);

  lv_obj_t *test2 = lv_triple_label(
      right_data_panel, &steering.lb_LV_TEMP, "20", &lv_font_inter_bold_38,
      "°C", &lv_font_inter_bold_22, "LV", &lv_font_inter_bold_18);
  lv_obj_set_grid_cell(test2, LV_GRID_ALIGN_CENTER, 1, 1, LV_GRID_ALIGN_CENTER,
                       1, 1);

  lv_obj_t *test3 = lv_triple_label(
      right_data_panel, &steering.lb_HV_TEMP, "12", &lv_font_inter_bold_38,
      "°C", &lv_font_inter_bold_22, "HV", &lv_font_inter_bold_18);
  ...
  // power
  lv_obj_t *power = lv_triple_label(
      central_panel, &steering.lb_POWER, "60", &lv_font_inter_bold_38, "%",
      &lv_font_inter_bold_22, "POWER", &lv_font_inter_bold_14);
  ...
  lv_obj_t *speed = lv_vertical_pair_label(
      data_panel, &steering.lb_ESTIMATED_VELOCITY, "169",
  ...
  lv_custom_meter(&steering.custom_meter, steering.lb_POWER,
                  steering.lb_GPS_SPEED, &steering.POWER);
  ...
  lv_obj_t *lap_counter = lv_vertical_pair_label(
      data_panel, &steering.lb_LAP_COUNT, "12", &lv_font_inter_bold_38, "LAP",
      &lv_font_inter_bold_22);
  ...
  lv_obj_t *km_counter = lv_vertical_pair_label(data_panel, &steering.lb_KM,
                                                "1.12", &lv_font_inter_bold_38,
                                                "KM", &lv_font_inter_bold_22);
...
void lv_custom_meter(lv_obj_t **custom_meter,
  ...
  lv_meter_set_indicator_end_value(*custom_meter, indicator_white,
                                   *max_indicator_value); /*range values 0-100*/
  ...
  lv_meter_set_indicator_value(*custom_meter, indicator_blue, 5);
  lv_meter_set_indicator_value(*custom_meter, indicator_white, 3);
