...
void tab_racing(lv_obj_t *parent) {
  ...
  static lv_coord_t main_panel_cols[] = {SIDE_BAR_WIDTH, CENTRAL_PANEL_WIDTH,
                                         SIDE_BAR_WIDTH, LV_GRID_TEMPLATE_LAST};
  ...
  lv_obj_t *lv_perc = lv_horizontal_pair_label(
      bar_panel_lv, "80", &lv_font_montserrat_30, "%", &lv_font_montserrat_30);
  lv_obj_align(lv_obj_get_child(lv_obj_get_child(lv_perc, 1), NULL),
  ...
  lv_obj_set_style_text_font(label_lv, &lv_font_montserrat_30,
                             LV_STATE_DEFAULT);
  ...
  //   lv_obj_set_grid_cell(lv_bar, LV_GRID_ALIGN_CENTER, 0, 1,
  ...
  lv_obj_t *hv_perc = lv_horizontal_pair_label(
      bar_panel_hv, "50", &lv_font_montserrat_30, "%", &lv_font_montserrat_30);
  lv_obj_align(lv_obj_get_child(lv_obj_get_child(hv_perc, 1), NULL),
               LV_ALIGN_CENTER, 0, 5); // change "%" position
  ...
  lv_obj_set_style_text_font(label_hv, &lv_font_montserrat_30,
                             LV_STATE_DEFAULT);
  ...
  static lv_coord_t cpanel_cols[] = {CENTRAL_PANEL_WIDTH,
                                     LV_GRID_TEMPLATE_LAST};
  static lv_coord_t cpanel_rows[] = {TOP_BAR_HEIGHT, DATA_PANEL_HEIGHT,
                                     BOTTOM_BAR_HEIGHT, LV_GRID_TEMPLATE_LAST};
  ...
  // DATA PANEL
  static lv_coord_t dpanel_cols[] = {DATA_LEFT_WIDTH, DATA_CENTER_WIDTH,
                                     DATA_RIGHT_WIDTH, LV_GRID_TEMPLATE_LAST};
  ...
  // DATA PANEL LEFT
  static lv_coord_t lxd_panel_cols[] = {DATA_LEFT_WIDTH - 5,
                                        LV_GRID_TEMPLATE_LAST};
  ...
  lv_obj_t *best_time = lv_vertical_pair_label(
      left_data_panel, " 1:24:03", &lv_font_montserrat_30, "BEST TIME",
      &lv_font_montserrat_30);
  lv_obj_align(lv_obj_get_child(lv_obj_get_child(best_time, 1), NULL),
  ...
  lv_obj_t *last_time = lv_vertical_pair_label(
      left_data_panel, " 1:25:33", &lv_font_montserrat_30, "LAST TIME",
      &lv_font_montserrat_30);
  lv_obj_align(lv_obj_get_child(lv_obj_get_child(last_time, 1), NULL),
               LV_ALIGN_LEFT_MID, 10, 0); // change bottom label position
  lv_obj_set_grid_cell(last_time, LV_GRID_ALIGN_START, 0, 1,
                       LV_GRID_ALIGN_CENTER, 1, 1);

  lv_obj_t *delta =
      lv_vertical_pair_label(left_data_panel, "3.2", &lv_font_montserrat_30,
                             "DELTA", &lv_font_montserrat_30);
  lv_obj_align(lv_obj_get_child(lv_obj_get_child(delta, NULL), NULL),
               LV_ALIGN_LEFT_MID, 10, 0); // change upper label position
  lv_obj_align(lv_obj_get_child(lv_obj_get_child(delta, 1), NULL),
               LV_ALIGN_LEFT_MID, 10, 0); // change bottom label position
  ...
  lv_obj_set_size(right_data_panel, DATA_RIGHT_WIDTH - 5,
                  DATA_PANEL_HEIGHT - 2);
  ...
  lv_obj_t *trq =
      lv_vertical_pair_label(right_data_panel, "30", &lv_font_montserrat_30,
                             "TRQ", &lv_font_montserrat_30);
  lv_obj_set_grid_cell(trq, LV_GRID_ALIGN_CENTER, 0, 1, LV_GRID_ALIGN_CENTER, 0,
                       1);

  lv_obj_t *slip =
      lv_vertical_pair_label(right_data_panel, "20", &lv_font_montserrat_30,
                             "%", &lv_font_montserrat_30);
  ...
  lv_obj_set_style_border_color(sep_line, lv_color_hex(COLOR_SECONDARY_HEX),
                                LV_PART_MAIN);
  ...
  lv_obj_set_grid_cell(sep_o, LV_GRID_ALIGN_START, 0, 1, LV_GRID_ALIGN_STRETCH,
                       1, 1);

  lv_obj_t *test =
      lv_triple_label(right_data_panel, "20", &lv_font_montserrat_30, "°C",
                      &lv_font_montserrat_30, "INV", &lv_font_montserrat_30);
  ...
  lv_obj_set_grid_cell(power, LV_GRID_ALIGN_CENTER, 1, 1, LV_GRID_ALIGN_START,
                       0, 1);

  // speedometer
  lv_obj_t *speed =
      lv_vertical_pair_label(data_panel, "169", &lv_font_montserrat_30, "km/h",
                             &lv_font_montserrat_30);
  ...
  lv_obj_t *lap_counter = lv_vertical_pair_label(
      data_panel, "12", &lv_font_montserrat_30, "LAP", &lv_font_montserrat_30);
  ...
  lv_obj_t *km_counter = lv_vertical_pair_label(
      data_panel, "1.12", &lv_font_montserrat_30, "KM", &lv_font_montserrat_30);
